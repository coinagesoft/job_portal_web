(function($) {
    ...
    if ($("#circle-staticstic-demo").length && typeof $.fn.circliful === "function") {
        var circlePercent = parseInt($("#circle-staticstic-demo").attr("data-percent"), 10);
        $("#circle-staticstic-demo").empty().circliful({
            animation: 1,
            foregroundBorderWidth: 10,
            backgroundBorderWidth: 10,
            percent: isNaN(circlePercent) ? 67 : circlePercent,
